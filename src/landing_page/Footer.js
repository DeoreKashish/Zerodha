  ...
  return (
    ...
    <div className="container border-top mt-5" >
      <div className="row mt-5">
        <div className="col">
          <img src="Assests\logo.svg" style={{ width: "50%" }} alt="logo" />
          <p>
        ...
        <div className="col">
          <p>Company</p>
          <a href="" style={{textDecorationLine:"none"}}>About</a>
          <br />
          <a href=""  style={{textDecorationLine:"none"}}>Products</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>Pricing</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>Referral programme</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>Careers</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>Zerodha.tech</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>Press & media</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>Zerodha cares (CSR)</a>
          <br />
        </div>
        <div className="col">
          <p>Support</p>
          <a href="" style={{textDecorationLine:"none"}}>Contact</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>Support portal</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>Z-Connect blog</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>List of charges</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>Downloads & resources</a>
          <br />
        </div>
        <div className="col">
          <p>Account</p>
          <a href="" style={{textDecorationLine:"none"}}>Open an account</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>Fund transfer</a>
          <br />
          <a href="" style={{textDecorationLine:"none"}}>60 day challenge</a>
          <br />
        </div>
      </div>
